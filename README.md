...
- [Usage](#usage)
- [Example](#example)
- [Synthetic Data Generation and Evaluation](#synthetic-data-generation-and-valuation)
...
...
```
All benchmark datasets used in this study, including both synthetic and real-world datasets, are publicly available on Zenodo at https://doi.org/10.5281/zenodo.21919392.

## Synthetic Data Generation and Evaluation
In the simulated-data experiments presented in this study, synthetic datasets were generated using both [BiBench](https://github.com/xguse/BiBench) and [G-Bic](https://github.com/jplobo1313/G-Bic). BiBench was additionally used to compute the relevance and recovery metrics.

For BiBench, we recommend creating a dedicated **Conda environment**, since it relies on an older Python/R software stack and may not be compatible with modern Python environments. The original BiBench source code is available at [https://github.com/xguse/BiBench](https://github.com/xguse/BiBench).

After installing and activating the BiBench environment, the synthetic datasets used in our experiments can be generated by running:

```bash
python ./test/bibench_syndata_generation.py
```
We also used G-Bic to generate additional synthetic datasets. The G-Bic source code is available at [https://github.com/jplobo1313/G-Bic](https://github.com/jplobo1313/G-Bic). The detailed parameter settings used for G-Bic data generation are provided in the Supplementary Materials.

For users who would like to quickly test the algorithm without installing BiBench, we provide a lightweight Python implementation for synthetic-data generation and relevance/recovery evaluation. This simplified version is intended to facilitate rapid testing and to avoid potential installation difficulties associated with BiBench. A complete example workflow covering synthetic data generation, algorithm execution, and performance evaluation is presented below.
